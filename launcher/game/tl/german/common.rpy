...
translate german strings:
    ...
    new "Möchtest du das Spiel wirklich verlassen?"
    ...
    new "Bist Du sicher, dass Du das Vorspulen starten möchtest?"
    ...
    new "Zwischenablage-Sprachausgabe aktiviert. Drücke 'Shift+C' zum Deaktivieren."
...
translate german strings:
    ...
    new "Lautstärkeabfall der Sprachausgabe"
    ...
    new "Der interaktive Editor ist hier nicht aktiviert."
    ...
    new "Klicke, um das Attribut umzuschalten; klicke mit der rechten Maustaste, um das negative Attribut umzuschalten."
    ...
    new "Vertraust Du dem Gerät, auf dem der Spielstand erstellt wurde? Du solltest nur dann Ja wählen, wenn Du der einzige Benutzer des Geräts bist."
    ...
    new "Geschwindigkeit beim Vorspulen"
    ...
    old "automatic move"
    new "automatischer Zug"

    # renpy/common/00preferences.rpy:392
    old "wait for voice"
    new "auf Sprachausgabe warten"

    # renpy/common/00preferences.rpy:401
    old "voice sustain"
    new "Verzögerung der Sprachausgabe"
